...
def make_data(node_size, train_size, folder_path):
    ...
    accuracy_label_cat_1 =  [[0.8, 'gender','female','male'], [0.8, 'age', 'young', 'middle_age', 'old']]
    accuracy_label_cat_2 =  [[0.9, 'gender','female','male'], [0.9, 'age', 'young', 'middle_age', 'old']]
    # create user data
...
model_txt = '''10: Source(S) & Predicts(S,U,A,L)-> Is(U,A,L)^2
10: Source(S) & ~Predicts(S,U,A,L)-> ~Is(U,A,L)^2
